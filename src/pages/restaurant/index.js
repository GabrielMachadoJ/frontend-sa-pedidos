...
import { Button, Card, Dialog, DialogContent, DialogTitle, Grid, IconButton, Modal } from "@mui/material";
...
export default function Restaurant() {
  ...
  const SecaoComponent = ({ secaoNome, opcoes }) => {
    return (
      ...
      >
        <div >
          <h2 style={{ fontSize: '1.6rem', fontWeight: 400, marginBottom: '1.2rem' }}>{secaoNome}.</h2>
            ...
            {opcoes.map(opcao => (
              <Grid key={opcao.id} item xs={12} sm={6} md={6} lg={6}>
                ...
                >
                  ...
                  <div style={{ borderLeft: '1px solid #e4d9d97a', width: '10rem' }}>
                    <img
              ...
              <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '.6rem', width: '35rem' }}>
                ...
                <div style={{ border: '1px solid #d6d3d3', borderRadius: '.2rem', padding: '.2rem .1rem', display: 'flex', justifyContent: 'space-between', alignItems: 'center', width: '8rem' }}>
                  <IconButton
                    ...
                    style={{
                      borderRadius: 0,
                      cursor: quantidadeSelecionada === 0 ? 'not-allowed' : 'pointer'
                    }} >
                ...
                >Adicionar &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; R$ {`${(opcaoSelecionada.preco * quantidadeSelecionada).toFixed(2)}`.replace('.', ',')}</Button>
              </div>
            </div>
          </div>
        </DialogContent>
